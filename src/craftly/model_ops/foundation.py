"""Scratch-model foundation contracts for Craftly.

This module is intentionally not a fine-tuning wrapper. It defines the stable
contracts Craftly will use for tokenizer assets, decoder-only architecture
...
class ScratchDecoderConfig(StrictModel):
    """Canonical architecture contract shared by every Craftly model runtime."""

    architecture_version: int = Field(default=2, ge=1)
    name: str = "craftly-tiny-smoke"
...
def model_profiles() -> dict[str, ScratchDecoderConfig]:
    ...
    return {
        ...
        "50m": ScratchDecoderConfig(
            name="craftly-50m-scaling-pilot",
            vocab_size=128_000,
        ...
        "100m": ScratchDecoderConfig(
            name="craftly-100m-dense-ab",
            vocab_size=128_000,
            max_sequence_length=2_048,
            hidden_size=512,
            num_layers=12,
        ...
        "100m_moe": ScratchDecoderConfig(
            name="craftly-100m-active-mla-moe-ab",
            vocab_size=128_000,
            max_sequence_length=2_048,
            hidden_size=512,
            num_layers=12,
        ...
        "300m": ScratchDecoderConfig(
            name="craftly-300m-dense-ab",
            vocab_size=128_000,
            max_sequence_length=2_048,
            hidden_size=1_024,
            num_layers=14,
        ...
        "300m_moe": ScratchDecoderConfig(
            name="craftly-300m-active-mla-moe-ab",
            vocab_size=128_000,
            max_sequence_length=2_048,
            hidden_size=1_024,
            num_layers=14,
            ...
            num_shared_experts=1,
            experts_per_token=2,
            moe_intermediate_size=986,
            router_bias_update_rate=0.001,
            mtp_num_layers=1,
            gradient_checkpointing=True,
        ),
        "1b": ScratchDecoderConfig(
            name="craftly-1b-scratch",
            vocab_size=128_000,
        ...
        "1b_moe": ScratchDecoderConfig(
            name="craftly-1b-active-mla-moe-ab",
            vocab_size=128_000,
            max_sequence_length=65_536,
            effective_context_length=5_000_000,
            hidden_size=2048,
        ...
        "7b_moe": ScratchDecoderConfig(
            name="craftly-7b-active-mla-moe-candidate",
            vocab_size=128_000,
            max_sequence_length=131_072,
            effective_context_length=5_000_000,
            hidden_size=4096,
        ...
        "4t_moe": ScratchDecoderConfig(
            name="craftly-4t-moe-128b-active",
            vocab_size=128_000,
...
def model_profile(name: str) -> ScratchDecoderConfig:
    ...
    key = normalized.removeprefix("craftly-").removeprefix("craftly-").replace("-", "_")
