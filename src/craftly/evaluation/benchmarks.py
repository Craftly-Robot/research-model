...
class BenchmarkRunReport(StrictModel):
    ...
    def write_markdown(self, path: str | Path) -> Path:
        ...
        lines = [
            f"# Craftly Benchmark Report {self.run_id}",
            "",
...
def built_in_security_tasks() -> list[BenchmarkTask]:
    return [
        BenchmarkTask(
            ...
            files={
                "app.py": "cursor.execute('SELECT * FROM users WHERE name=' + user_input)"
            },
        ...
        BenchmarkTask(
            ...
            files={
                "main.go": 'db.Query("SELECT * FROM users WHERE name=\'" + name + "\'")'
            },
        ...
        BenchmarkTask(
            ...
            files={
                "main.rs": 'Command::new("sh").arg("-c").arg(user_input).status()?;'
            },
        ...
        BenchmarkTask(
            ...
            files={
                "workflow.yml": "run: echo '${{ github.event.issue.title }}' | bash"
            },
