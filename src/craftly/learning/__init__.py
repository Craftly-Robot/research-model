...
_EXPORTS = {
    "ContaminationDetector": ("src.craftly.learning.benchmark_contamination_filter", "ContaminationDetector"),
    "ContaminationReport": ("src.craftly.learning.benchmark_contamination_filter", "ContaminationReport"),
